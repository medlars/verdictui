...
- [ ] (P1) testwatch: add test for `Mutation` in `scripts/mutation-check.py` [NONE]
- [ ] (P1) testwatch: add test for `check` in `scripts/mutation-check.py` [NONE]
- [ ] (P1) testwatch: add test for `git_is_clean` in `scripts/mutation-check.py` [NONE]
- [ ] (P1) testwatch: add test for `main` in `scripts/mutation-check.py` [NONE]
