...
## P1 — High Priority
- [ ] (P1) CEO/stage_installed_parity: installed verdictui STALE at /opt/homebrew/bin/verdictui — missing ['capture', 'check', 'headless', 'live', 'observe', '
- [ ] (P1) CEO/stage_todo_review: 8 open (2 P0, 3 P1, 3 P2, 0 P3) [source: todo.md]: 2 open P0 TODO(s) — (2026-09-23) Desktop workbench: owner-selected we
