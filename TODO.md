...
- [ ] (P2) testwatch: add test for `_ceo_paths_are_available` in `scripts/verdictui-pm.py` [NONE]
- [ ] (P2) testwatch: add test for `_prepare_pm_base_import_environment` in `scripts/verdictui-pm.py` [NONE]
- [ ] (P2) testwatch: add test for `_restore_pm_base_import_environment` in `scripts/verdictui-pm.py` [NONE]
