...
## P0 — Blocking
- [ ] (2026-09-23) Browser acceptance blockers measured during 1.1.2 final review: static overflow intermediaries falsely clip positioned descendants and hide actual overlaps; retained-inline capture rejects a valid rich-text editor; dynamic remote iframe insertion can invalidate the in-flight parent snapshot. Repair both with actual browser controls, retained redaction, targeted mutations and restored tests before publishing CTS-B70C5383. Evidence: finalization-plan and finalization logs.
...
## P1 — High Priority
- [ ] (2026-09-23) CTS-B70C5383: complete measured inline border fragments, containing-block-aware absolute/fixed clipping, and conservative SVG/presentation handling with explicit paint-unverified qualification; rebuild and notarize the superseding 1.1.2 candidate. Run green PM/CEO readiness, publish tag/archive/checksum/formula, replace installed app and both CLI copies, run final installed native/browser/public-site/budget gates, publish website, and reconcile instruction evidence and final PM/CEO records. Continue immediately; this is required release delivery.
